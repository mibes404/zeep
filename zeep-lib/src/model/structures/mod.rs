...
struct Person {
    ...
    fn prep_struct_props(target_namespace: Option<Rc<TargetNamespace>>) -> ComplexProps {
        ComplexProps {
...
";
    ...
    fn prep_simple_props(target_namespace: Option<Rc<TargetNamespace>>) -> Box<SimpleProps> {
        SimpleProps {
            xml_name: "Person".to_string(),
            rust_type: RustFieldType::String,
            target_namespace,
