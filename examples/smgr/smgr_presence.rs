...
pub mod types {
    ...
    #[yaserde(
        prefix = "tns",
        namespace = "tns: http://xml.avaya.com/schema/presence",
        rename = "XmlPsCommProfile",
        default
    )]
    pub struct XmlPsCommProfile {
        #[yaserde(flatten)]
        pub xml_comm_profile_type: XmlCommProfileType,
        #[yaserde(prefix = "tns", rename = "system", default)]
        pub system: String,
        #[yaserde(prefix = "tns", rename = "imGatewaySipEntity", default)]
        pub im_gateway_sip_entity: Option<String>,
        #[yaserde(prefix = "tns", rename = "publishViaAESCollector", default)]
