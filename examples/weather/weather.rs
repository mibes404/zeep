...
pub mod types {
    ...
    pub struct GetWeatherInformationResponse {
        ...
        pub get_weather_information_result: ArrayOfWeatherDescription,
    }
    ...
    pub struct GetCityForecastByZIPResponse {
        ...
        pub get_city_forecast_by_zip_result: ForecastReturn,
    }
    ...
    pub struct ForecastReturn {
        ...
        pub weather_station_city: String,
        #[yaserde(prefix = "tns", rename = "ForecastResult", default)]
        pub forecast_result: ArrayOfForecast,
    }
    ...
    pub struct Temp {
        ...
        pub morning_low: String,
        #[yaserde(prefix = "tns", rename = "DaytimeHigh", default)]
        pub daytime_high: String,
    }
